...
<div class="FormTitleWrapper">
    ...
    <div class="FormWrapper">
        ...
        <ul>
		 ...
		 <li>
                <?php
                echo $this->Form->label('Web Dev Created a new field here!', 'Name');
                echo $this->Form->textBox('Name', array('autocorrect' => 'off', 'autocapitalize' => 'off', 'Wrap' => TRUE));
                echo '<span id="NameUnavailable" class="Incorrect" style="display: none;">'.t('Name Unavailable').'</span><br/><br/>';
                ?>
            </li>
                ...
                <li>
                    ...
                    echo $this->Form->textBox('Email', array('name' => 'Email', 'type' => 'email', 'Wrap' => TRUE));
            ...
            <li class="Buttons">
                <?php echo $this->Form->button('Sign Up', array('name'=>'submit', 'class' => 'Button Primary')); ?>
            </li>
        </ul>
